...
function LinkCard({ href, title, image, bgshine, disable }: {href: string; title:string; image?:string; bgshine:string; disable:string}) {
  return(
    <a
      href={href}
      target="_blank"
      rel="noopener noreferrer"
      className={`flex items-center p-1 w-full rounded-md hover:scale-105 transition-all shadow-2xl bg-cyan-50 mb-3 max-w-sm ${bgshine} ${disable}`}
    >
